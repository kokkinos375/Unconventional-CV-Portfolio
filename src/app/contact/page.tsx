    ...
    >
      <div className="mt-12 space-y-8 font-mono">
        ...
        <motion.div 
          ...
          className="border border-cyan-500/20 bg-cyan-500/5 p-8 rounded-sm shadow-[0_0_30px_rgba(34,211,238,0.05)]"
        >
          <div className="space-y-6">
            <div>
              <p className="text-[0.6rem] uppercase tracking-[0.3em] text-cyan-500/60 mb-1">Primary Operator</p>
              <p className="text-xl text-stone-100 uppercase tracking-wider">Michail Kokkinos</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <a href="tel:+306947569787" className="text-stone-100 hover:text-cyan-400 transition-colors">
                  6947 569787
                </a>
              </div>
              <div>
                <p className="text-[0.6rem] uppercase tracking-[0.3em] text-cyan-500/60 mb-1">Encrypted Comms</p>
                <a href="mailto:michael.kokkinos375@gmail.com" className="text-stone-100 hover:text-cyan-400 transition-colors">
        ...
        {/* System Status Note */}
        <p className="text-[0.6rem] uppercase tracking-[0.4em] text-zinc-600 text-center italic">
